...
public:
	...
	static const int MSP_ERROR_INVALID_PARA					= 10106; 	/* 0x277A */
	static const int MSP_ERROR_INVALID_PARA_VALUE			= 10107; 	/* 0x277B */
	static const int MSP_ERROR_INVALID_HANDLE				= 10108; 	/* 0x277C */
	static const int MSP_ERROR_INVALID_DATA					= 10109; 	/* 0x277D */
	static const int MSP_ERROR_NO_LICENSE					= 10110; 	/* 0x277E */
	static const int MSP_ERROR_NOT_INIT						= 10111; 	/* 0x277F */
	static const int MSP_ERROR_NULL_HANDLE					= 10112; 	/* 0x2780 */
	static const int MSP_ERROR_OVERFLOW						= 10113; 	/* 0x2781 */
	static const int MSP_ERROR_TIME_OUT						= 10114; 	/* 0x2782 */
	static const int MSP_ERROR_OPEN_FILE						= 10115; 	/* 0x2783 */
	static const int MSP_ERROR_NOT_FOUND						= 10116; 	/* 0x2784 */
	static const int MSP_ERROR_NO_ENOUGH_BUFFER				= 10117; 	/* 0x2785 */
	static const int MSP_ERROR_NO_DATA						= 10118; 	/* 0x2786 */
	static const int MSP_ERROR_NO_MORE_DATA					= 10119; 	/* 0x2787 */
	static const int MSP_ERROR_NO_RESPONSE_DATA				= 10120; 	/* 0x2788 */
	static const int MSP_ERROR_ALREADY_EXIST					= 10121; 	/* 0x2789 */
	...
	static const int MSP_ERROR_BOS_TIMEOUT                   = 10140;    /* 未检测到语音 */
...
#undef ERROR_NO_MATCH
	static const int ERROR_NO_MATCH 					               = 20005; /* 无匹配结果 */
